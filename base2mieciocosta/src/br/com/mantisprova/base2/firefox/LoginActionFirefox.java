...
public class LoginActionFirefox {

	// path do geckodriver localizado na máquina
	@BeforeClass
	public static void startFf() throws InterruptedException {
		System.setProperty("webdriver.gecko.driver",
				File.separator + "home" + File.separator + "miecio" + File.separator + "eclipse-workspace"
						+ File.separator + "AutoMantis" + File.separator + "jars" + File.separator + "geckodriver");
	}

	// Chamada do teste a ser execucado pelo Firefox
	@Test(invocationCount = 1)
	public void loginFfBackEnd() throws MalformedURLException, InterruptedException {

		DesiredCapabilities crm = new DesiredCapabilities();
		crm.setBrowserName(BrowserType.FIREFOX);
